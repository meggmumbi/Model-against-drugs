...
import com.example.mads.Adapters.MessageAdapter;
import com.example.mads.Models.Chat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mentor_toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(MessageActivity.this, MentorActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
            }
        });
